  ...
  return (
    ...
    <div className="input-side">
      <div className="user-form">
         ...
         <Inputs change={handleChange}  label="Email" type="email" id="email" name="email" value={inputs.email || ""} placeholder="Enter your email" />
         ...
         <SubmitBtn btntext="login" style={btnBg} />
         </form>
         <div className="sign-in-footer">
          ...
          <svg width="25px" height="25px" viewBox="-3 0 262 262" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
            <g>
          ...
          <div className="footer">
            <Paragraph class="dark-paragraph" ParagraphText="don't have an account?" />
            <Link to={"/signup"}><h1>sign up</h1></Link>
          </div>
          <Paragraph class="purple-paragraph" ParagraphText="forgot password?" />
         </div>
         </div>
      </div>
    </section>
